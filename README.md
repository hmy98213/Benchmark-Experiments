...
## Download External Bench Data

`random` and `prefix_repetition` are synthetic datasets generated by vLLM and do not need downloads.
`spec_bench` needs the original JSONL file:
